...
<tr>
    ...
    <div id="content-table-inner">
		...
		$pelajaran=mysqli_fetch_array(mysqli_query($koneksi,"select * from setup_pelajaran where id_pelajaran='$id_pelajaran'"));
      ...
      <br />
        ...
        <?php
		$view=mysqli_query($koneksi,"SELECT * FROM tbl_nilai nilai, data_siswa siswa WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_guru='$id_guru' and nilai.id_kelas='$id_kelas' and nilai.id_pelajaran='$id_pelajaran' order by siswa.nama_siswa asc");
