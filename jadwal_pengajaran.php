...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"insert into tbl_jadwal values('','$id_guru','$id_pelajaran','$id_kelas')");
...
<tr>
    ...
    <div id="content-table-inner">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    ...
                    <tr>
                      ...
                      <td><select name="id_pelajaran"  class="styledselect_form_1">
                          ...
                          <?php
						  $pelajaran=mysqli_query($koneksi,"select * from setup_pelajaran order by nama_pelajaran asc");
						  while($row2=mysqli_fetch_array($pelajaran)){
						  ?>
        ...
        <?php
		$view=mysqli_query($koneksi,"select * from tbl_jadwal jadwal, setup_kelas kelas, setup_pelajaran pelajaran, data_guru guru where jadwal.id_kelas=kelas.id_kelas and jadwal.id_pelajaran=pelajaran.id_pelajaran and jadwal.id_guru=guru.id_guru order by id_jadwal asc");
