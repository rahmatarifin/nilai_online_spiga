...
<tr>
    ...
    <div id="content-table-inner">
		...
		$siswa=mysqli_fetch_array(mysqli_query($koneksi,"select siswa.nama_siswa, siswa.nis, kelas.nama_kelas from tbl_ruangan ruangan, data_siswa siswa, setup_kelas kelas where ruangan.id_siswa=siswa.id_siswa and ruangan.id_siswa='$id_siswa' and ruangan.id_kelas=kelas.id_kelas"));
      ...
      <br />
        ...
        <?php
		$view=mysqli_query($koneksi,"SELECT nama_pelajaran, nilai FROM tbl_nilai nilai, setup_pelajaran pelajaran WHERE nilai.id_siswa='$id_siswa' and nilai.id_pelajaran=pelajaran.id_pelajaran order by pelajaran.nama_pelajaran asc");
