		...
		<div id="content-table-inner">
                  ...
                  <table border="0" cellpadding="0" cellspacing="0"  id="id-form">
                    <tr>
                     ...
                     <tr>
                      ...
                      <?php
					  $siswa=mysqli_query($koneksi,"select * from data_siswa order by nama_siswa asc");
            ...
            <tr>
              ...
              <td></td>
				...
				$view=mysqli_query($koneksi,"SELECT nama_siswa, nis, nama_guru, nip, nama_kelas, nama_pelajaran, nilai FROM tbl_nilai nilai, data_siswa siswa, setup_pelajaran pelajaran, setup_kelas kelas, data_guru guru WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_kelas=kelas.id_kelas and nilai.id_pelajaran=pelajaran.id_pelajaran and nilai.id_guru=guru.id_guru $filter_guru $filter_siswa $filter_pelajaran $filter_kelas order by siswa.nama_siswa asc");
