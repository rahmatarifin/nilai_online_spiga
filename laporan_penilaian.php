	...
	<tr>
		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				$view=mysqli_query($koneksi,"SELECT * FROM tbl_nilai nilai, data_siswa siswa, setup_pelajaran pelajaran, setup_kelas kelas WHERE nilai.id_siswa=siswa.id_siswa and nilai.id_kelas=kelas.id_kelas and nilai.id_pelajaran=pelajaran.id_pelajaran and nilai.id_guru='$id_guru' order by siswa.nama_siswa asc");
