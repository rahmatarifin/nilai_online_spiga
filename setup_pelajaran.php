...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"insert into setup_pelajaran values('','$nama_pelajaran')");
...
<tr>
    ...
    <div id="content-table-inner">
        ...
        <?php
		$view=mysqli_query($koneksi,"select * from setup_pelajaran order by nama_pelajaran asc");
