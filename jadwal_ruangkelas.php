...
if(isset($_POST['submit'])){
	...
	$query=mysqli_query($koneksi,"insert into tbl_ruangan values('','$id_siswa','$id_kelas')");
...
<tr>
    ...
    <div id="content-table-inner">
        ...
        <?php
		$view=mysqli_query($koneksi,"select * from tbl_ruangan ruangan, setup_kelas kelas, data_siswa siswa where ruangan.id_kelas=kelas.id_kelas and ruangan.id_siswa=siswa.id_siswa order by id_ruangan asc");
