...
<tr>
    ...
    <div id="content-table-inner">
      ...
      <br />
        ...
        <?php
		$view=mysqli_query($koneksi,"SELECT * FROM tbl_ruangan ruangan, data_siswa siswa WHERE ruangan.id_siswa=siswa.id_siswa and ruangan.id_kelas='$id_kelas' order by siswa.nama_siswa asc");
